    ...
    <div class="container px-3 py-2">
        <a class="navbar-brand text-info-emphasis" href="#">KOPRAL BABI</a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <a class="nav-link fs-5 text-info-emphasis" href="{{ route('desa.index') }}"><i class="bi bi-houses-fill"></i></i> Desa</a>
                <a class="nav-link fs-5 text-info-emphasis" href="{{ route('cluster.index') }}"><i class="bi bi-exclude"></i></i> Cluster</a>
